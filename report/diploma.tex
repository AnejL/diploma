...
Po opravljenem vnosu podatkov, se fotografija zašifrira v znakovni niz po metodi Base64.
Vsebina vnosnih polj se zapiše v objekt razreda \texttt{Note}.

Korak \texttt{Note} in šifrirana fotografija se zapišeta v objekt razreda \texttt{UploadImageRequest}.
...
Polje \texttt{ImageString} vsebuje fotografijo, po metodi Base64 šfirirano v znakovni niz.
...
Tekstovni korak ima to polje nastavljeno na vrednost \texttt{false}, slikovni pa \texttt{true}.
...
% Ugotavljamo, da je za dobro zasnovano veščino za Amazon Alexo treba upoštevati Alexine omejitve.
% Če bi želeli zmanjšati čas obdelave večih zaporednih glasovnih ukazov, lahko ustvarimo več veščin in prožimo funkcionalnosti ob pozivu.
% Če pa je naš namen razširiti nabor funkcionalnosti, pa je smiselno v sklopu ene veščine definiramo namere, ki so 
