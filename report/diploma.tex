...
% V primerjavi s sistemom, ki ga želimo implementirati, ta metoda zaostaja predvsem 
...
% Do svojih delavniških dnevnikov lahko dostopa le avtenticiran uporabnik.
...
% Preden dobi uporabnik avtorizacijski žeton, mora vzpostaviti zaupanje s strežnikom.
...
Če uporabnik računa nima, se mora registrirati.
Pri registraciji odjemalec na strežnik pošlje objekt razreda \textit{RegisterUserRequest} na URL \enquote{\texttt{/identity/-\\register}} preko metode POST.
...
% Storitev za upravljanje z glasovnim pomočnikom (razred \texttt{VoiceAssistantService.cs}) skrbi za zahtevanje in sprostitev glasovnega pomočnika.
