...
Za področje, ki ga želimo izboljšati, smo si izbrali sestavljanje delavniškega dnevnika ali opisa tehnološkega postopka.
Kljub temu se bo naš sistem, z manjšimi spremembami, lahko uporabil tudi za sestavljanje drugačnih vrst poročil in navodil.
...
V sklopu diplomske naloge smo želeli izdelati specializiran sistem za sestavljanje delavniških dnevnikov, nato pa preveriti, ali lahko z vpeljavo glasovnega pomočnika delo s tem sistemom pohitrimo.
...
Odjemalci, ki bodo nanj povezani, služijo zgolj kot \enquote{uporabniški vmesnik} za prikaz podatkov na strežniku.
...
Uporabnik mora imeti uporabniško ime, katerega bo uporabljal za prijavo in geslo s katerim bo dokazal, da je to res on.
...
\texttt{OpenTextNoteFormIntent} se zažene, ko po pozivu uporabnik izreče ''\texttt{create a text note}''.
...
Preko aplikacije se bo uporabnik lahko registriral in prijavil v sistem, dodajal, brisal, odpiral in izvažal svoje delavniške dnevnike, itd.
V delavniške dnevnike bo lahko dodajal korake, ki opisujejo delo, jim spreminjal vsebino ter urejal vrstni red.

Preko te aplikacije bo lahko tudi zahteval in izpustil glasovnega asistenta.
Z mobilno napravo bo lahko tudi zajemal slike in jih v delavniške dnevnike dodal kot slikovno gradivo.
...
Ko uporabnik pritisne na gumb ''Connect'', se preveri, ali je naslov pravilno vnešen.
...
Po prijavi lahko uporabnik odpre stran z delavniškimi dnevniki, imenovano Dashboard.
...
Da uporabnik izbriše delavniški dnevnik, mora na strani ''My projects'' ob željenem projektu pritisniti gumb z ikono smetnjaka.
...
Ko uporabnik iz seznama delavniških dnevnikov izbere projekt, ki ga želi odpreti, storitev za komunikacijo s strežnikom pošlje na URL ''\texttt{/projects/\{id\}/notes}'' zahtevek GET.
